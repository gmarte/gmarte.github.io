...
const skillsSection = {
  ...
  skills: [
    emoji("🌌 Responsible for the design, development, and maintenance of SAP systems and applications"),
    emoji("💥 Proficient in automating tasks and integrating applications with REST API(JSON, Python, C#)."),
    emoji("⚡ Working with various SAP modules and technologies, such as SAP ABAP, HANA, UI5/Fiori, NetWeaver, and integration technologies like PI/PO, CPI, HCI"),
    emoji("🧑‍💼 Collaborating and working with geographically remote teams,  business partners and stakeholders to ensure successful delivery of projects")
  ],
...
https://fontawesome.com/icons?d=gallery */
  ...
  softwareSkills: [
    ...
    {
      skillName: "abap",
      fontAwesomeClassname: "fa-solid fa-display-code"
    },
    {
      skillName: "python",
